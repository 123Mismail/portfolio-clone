      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          ...
          <div key={idx}>
          {
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center justify-center  sm:py-2 md:p-2 flex space-x-1 text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500  "
            )}
          >
